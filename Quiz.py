...
class Quiz_Window(Toplevel):
    ...
    def display_result(self):
        ...
        if self.correct >= 8:
            img = ImageTk.PhotoImage(Image.open(r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\great.jpg'))
            ...
            img = ImageTk.PhotoImage(Image.open(r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\ok.png'))
            lbl_resut_img.configure(image=img)
            lbl_resut_img.image = img
            lbl_result_text.configure(text="You Can Do Better !!")
        else:
            img = ImageTk.PhotoImage(Image.open(r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\sad.png'))
            lbl_resut_img.configure(image=img)
            lbl_resut_img.image = img
...
root.iconbitmap(
    r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\ideas.ico')
...
# * Quiz Image and text:
img1 = ImageTk.PhotoImage(Image.open(r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\quiz_img1.jpg'))
lbl_img = Label(
    root,
    image=img1,
    bg='#ffffff')
...
img2 = ImageTk.PhotoImage(Image.open(r'C:\Users\Rishav raj\Desktop\Pythonca1\register\images\start_btn.png'))
btnStart = Button(
    root,
    image=img2,
    relief=FLAT,
